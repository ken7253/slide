...
<!--
というわけで本日はフロントエンドエンジニアとは近くて遠いブラウザの話を持ってきました。やっぱり普段のフロントエンド開発と言語もやっていることも全然違う話なんですけど、我々が書いたコードを動かす基盤がどう作られているのか、どう動いているのかみたいなことに興味を持つ人が増えるといいなという気持ちで
-->
...
<!--
もう結構前になりますが、自分が送ったパッチを含んだコードがFF148にてリリースされリリースノートに名前が載りました。今回はそちらの話を交えつつ普通のフロントエンドエンジニアが趣味レベルでブラウザ開発（バグ修正）に取り組む過程でのナレッジだったりを共有させていただければなと思います。
-->
